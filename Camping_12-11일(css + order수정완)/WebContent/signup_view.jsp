...
<body>
	...
	<div class="container">
		...
		<form action="sign_up.do" name="form" id="form" method="get">
			<div id="list"></div>
			<div id="callBackDiv">
				<table>
					<tr>
						<td style="height: 55px;"><input placeholder="ID" type="text"
							...
							style="height: 25px; width: 110px;"> &nbsp; <input
							style="height: 30px; width: 80px;" type="button"
							class="btn btn=primary" value="중복확인"
							onclick="confirmId(this.form);"></td>
					</tr>
					<tr>
					...
					<tr>
						<td style="height: 55px;"><input placeholder="이름" type="text"
							name="userName" id="userName" style="height: 25px;"></td>
					</tr>
					<tr>
						<td style="height: 55px;"><select name='tel1'
							style="height: 30px; width: 60px; border: 1px solid #E6E6E6;"
							size='1'>
								<option>010</option>
								<option>011</option>
								<option>017</option>
								<option>018</option>
						</select> - <input type="text" name="tel2" size='10' id="telNo"
					...
					<tr>
						<td style="height: 55px;"><input placeholder="우편번호"
							...
							name="zipNo" onclick="goPopup();" /> &nbsp; <input type="button"
							onClick="goPopup();" value="우편번호 찾기"
					...
					<tr>
						<td style="text-align: center;"><input
							...
							style="width: 100px; height: 30px;margin-top:30px;" type="submit" value="회원가입" "/>
